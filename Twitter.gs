/* -----GAS SETTINGS----- */
var GAS_PROJECT_KEY = PropertiesService.getScriptProperties().getProperty('GAS_PROJECT_KEY');

/* -----Twitter SETTINGS----- */
var TWITTER_CONSUMER_KEY = PropertiesService.getScriptProperties().getProperty('TWITTER_CONSUMER_KEY');
var TWITTER_CONSUMER_SECRET = PropertiesService.getScriptProperties().getProperty('TWITTER_CONSUMER_SECRET');
...
// -----Herrokkin Original-----
function tweetWithMedia(blob, status_txt) {
  var resp_64 = Utilities.base64Encode(blob.getBytes()); //TwitterAPI送信用にbase64にエンコード
  var form_data = {
    'media': blob
  }
  var img_option = {
